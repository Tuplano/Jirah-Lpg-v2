...
export function AddSupplierDialog() {
  ...
  const { mutate: addSupplier, isPending } = useCreateSupplier();
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle className="text-base">New Supplier</DialogTitle>
            <DialogDescription className="text-sm">
              Add a new supplier (planta) to your database.
            </DialogDescription>
          </DialogHeader>
